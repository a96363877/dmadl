            ...
            <div>
                ...
                {product.badge && (
                  <Badge
                    className={`absolute top-4 right-4 z-10 ${
                      product.badge === "جديد" ? "bg-teal-500" : product.badge === "خصم" ? "bg-red-500" : "bg-amber-500"
                    }`}
                  >
                    {product.badge}
                  </Badge>
              ...
              <div className="grid grid-cols-4 gap-2">
                {[1, 2, 3, 4].map((i) => (
                  <div
                    key={i}
                    className="relative h-24 rounded-md overflow-hidden border-2 border-transparent hover:border-teal-500 cursor-pointer"
                  >
            ...
            <div>
              ...
              <div className="mb-6">
                <PriceDisplay
                  ...
                  unit={product.unit}
                  priceClassName="text-2xl font-bold text-teal-700"
              ...
              <div className="mb-6">
                ...
                <div className="flex items-center">
                  ...
                  <span className="mr-3 text-sm text-gray-500">
                    متوفر: <span className="text-teal-700 font-medium">50</span> {product.unit}
                  </span>
                </div>
              </div>

              <div className="flex flex-col sm:flex-row gap-4 mb-8">
                <Button className="bg-teal-600 hover:bg-teal-700 flex-1" size="lg" onClick={handleAddToCart}>
                  إضافة للسلة
                </Button>
          ...
          <Tabs defaultValue="description" className="w-full">
            ...
            <TabsContent value="reviews" className="bg-white p-6 rounded-lg shadow-sm">
              <div className="flex items-center justify-between mb-6">
                ...
                <Button className="bg-teal-600 hover:bg-teal-700">أضف تقييمك</Button>
              </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {relatedProducts.map((relProduct) => (
              ...
              >
                ...
                <div className="p-4">
                  <Link href={`/product/${relProduct.id}`} className="hover:text-teal-600 transition-colors">
